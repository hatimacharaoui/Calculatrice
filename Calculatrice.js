...
function calculer() {
  ...
  if (choix == 1) {
    ...
    console.log(nb1 +" racine "+ " = "+resultat);
  } else if (choix == 7) {
    resultat = Factorielle(nb1);
    console.log(nb1 +" ! " + " = "+resultat);
  }
  return resultat;
}
...
let affichage = prompt("Voulez vous afficher l'historique des calculs? Oui/Non :");
if (affichage === "oui") {
  console.log("Historique: "+table);
}
}
